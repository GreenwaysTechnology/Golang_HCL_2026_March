...
const file_v1_user_proto_rawDesc = "" +
	"\n" +
	"\rv1/user.proto\x12\x06api.v1\"&\n" +
	"\vUserRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"C\n" +
	"\fUserResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername2C\n" +
	"\vUserService\x124\n" +
	"\aGetUser\x12\x13.api.v1.UserRequest\x1a\x14.api.v1.UserResponseB>Z<github.com/username/grpcschemasorganization/gen/go/v1;userv1b\x06proto3"
...
var file_v1_user_proto_goTypes = []any{
	(*UserRequest)(nil),  // 0: api.v1.UserRequest
	(*UserResponse)(nil), // 1: api.v1.UserResponse
}
var file_v1_user_proto_depIdxs = []int32{
	0, // 0: api.v1.UserService.GetUser:input_type -> api.v1.UserRequest
	1, // 1: api.v1.UserService.GetUser:output_type -> api.v1.UserResponse
